  ...
  if (hasStorageState) {
    try {
      ...
      const uniqueDomains = new Set(
        stateContent.cookies?.map((c: { domain: string }) => c.domain) || []
      );
      log.info(
        `[Browser] StorageState has ${cookieCount} cookies from ${uniqueDomains.size} unique domains, ${originCount} origins`
      );
    } catch (e) {
...
export async function getTextContent(
  ...
  try {
    ...
    return {
      success: false,
      message: `Get text failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function getPageHtml(
  ...
  try {
    ...
    return {
      success: false,
      message: `Get HTML failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function waitForNavigation(
  ...
  try {
    ...
    return {
      success: false,
      message: `Wait for navigation failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function getPageInfo(sessionId: string): Promise<BrowserActionResult> {
  try {
    ...
    return {
      success: false,
      message: `Get page info failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function setCheckbox(
  ...
  try {
    ...
    return {
      success: false,
      message: `Checkbox operation failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function goBack(sessionId: string): Promise<BrowserActionResult> {
  try {
    ...
    return {
      success: false,
      message: `Go back failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function goForward(sessionId: string): Promise<BrowserActionResult> {
  try {
    ...
    return {
      success: false,
      message: `Go forward failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function getLinks(sessionId: string): Promise<BrowserActionResult> {
  try {
    ...
    return {
      success: false,
      message: `Get links failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
...
export async function getFormInputs(sessionId: string): Promise<BrowserActionResult> {
  try {
    ...
    return {
      success: false,
      message: `Get form inputs failed: ${error instanceof Error ? error.message : String(error)}`,
    };
  }
}
