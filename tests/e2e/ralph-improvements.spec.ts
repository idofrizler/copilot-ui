...
test.describe('Ralph Loop Improvements', () => {
  ...
  test('01 - Initial app state before opening agent modes', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/01-initial-app-state.png', fullPage: true })
  ...
  test('02 - Open Agent Modes panel by clicking chevron button', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/02-agent-modes-panel-open.png', fullPage: true })
  })
  ...
  test('03 - Verify Ralph and Lisa cards are visible', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/03-ralph-lisa-cards-visible.png', fullPage: true })
  })
  ...
  test('04 - Click Ralph Wiggum card to enable', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/04-ralph-enabled-settings-visible.png', fullPage: true })
  })
  ...
  test('05 - Verify Max iterations input is visible with default value 5', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/05-max-iterations-default-5.png', fullPage: true })
  })
  ...
  test('06 - Verify Require screenshot checkbox is visible', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/06-require-screenshot-checkbox.png', fullPage: true })
  })
  ...
  test('07 - Verify Clear context checkbox is visible and checked by default', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/07-clear-context-checkbox-default-checked.png', fullPage: true })
  })

  test('08 - Uncheck Clear context checkbox', async () => {
    // Find the checkbox for clear context (near the label)
    const clearContextCheckbox = window.locator('label').filter({ hasText: 'Clear context between iterations' }).locator('input[type="checkbox"]')
    ...
    await window.screenshot({ path: 'evidence/screenshots/08-clear-context-unchecked.png', fullPage: true })
  })
  ...
  test('09 - Re-check Clear context checkbox', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/09-clear-context-rechecked.png', fullPage: true })
  })
  ...
  test('10 - Change max iterations to 10', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/10-max-iterations-changed-to-10.png', fullPage: true })
  })

  test('11 - Enable Require screenshot option', async () => {
    // Find and check the Require screenshot checkbox
    const screenshotCheckbox = window.locator('label').filter({ hasText: 'Require screenshot' }).locator('input[type="checkbox"]')
    ...
    await window.screenshot({ path: 'evidence/screenshots/11-require-screenshot-enabled.png', fullPage: true })
  })
  ...
  test('12 - All Ralph settings configured', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/12-all-ralph-settings-configured.png', fullPage: true })
  })
  ...
  test('13 - Switch to Lisa Simpson mode', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/13-lisa-simpson-selected.png', fullPage: true })
  })
  ...
  test('14 - Switch back to Ralph mode', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/14-ralph-mode-reselected.png', fullPage: true })
  })

  test('15 - Close Agent Modes panel', async () => {
    // Click the X button to close the panel
    const closeBtn = window.locator('button').filter({ has: window.locator('svg') }).first()
  ...
  test('16 - Reopen panel to verify Ralph is still selected', async () => {
    ...
    await window.screenshot({ path: 'evidence/screenshots/16-panel-reopened-ralph-still-selected.png', fullPage: true })
  })
})
