...
test.describe('App Launch', () => {
  ...
  test('should have theme controls', async () => {
    ...
    const themeButton = await window.locator('[data-testid="theme-dropdown"]').or(
      window.locator('button').filter({ has: window.locator('svg') })
    ).first()
...
test.describe('UI Elements', () => {
  ...
  test('should have window controls', async () => {
    ...
    const windowControls = await window.locator('[data-testid="window-controls"]').or(
      window.locator('.window-controls, [class*="WindowControls"]')
    ).first()
