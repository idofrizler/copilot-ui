...
describe('SearchableBranchSelect Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders with selected value', () => {
      render(
        <SearchableBranchSelect value="develop" branches={mockBranches} onSelect={mockOnSelect} />
      );
  ...
  describe('Dropdown Interaction', () => {
    ...
    it('calls onSelect when branch clicked', () => {
      ...
      const developOption = screen
        .getAllByRole('button')
        .find((btn) => btn.textContent?.includes('develop'));
      if (developOption) {
  ...
  describe('Empty State', () => {
    it('shows empty message when no branches', () => {
      render(<SearchableBranchSelect value={null} branches={[]} onSelect={mockOnSelect} />);
